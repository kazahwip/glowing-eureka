...
const ICONS = {
    catalog: '<svg viewBox="0 0 24 24"><path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h10"/></svg>',
    club: '<svg viewBox="0 0 24 24"><path d="M12 3l2.39 5.06 5.61.46-4.27 3.7 1.34 5.4L12 14.9l-5.07 2.72 1.34-5.4L4 8.52l5.61-.46L12 3z"/></svg>',
    reviews: '<svg viewBox="0 0 24 24"><path d="M21 12a8 8 0 0 1-11.6 7.14L4 21l1.86-5.4A8 8 0 1 1 21 12z"/></svg>',
    profile: '<svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M4 21c1.5-4 4.5-6 8-6s6.5 2 8 6"/></svg>',
    support: '<svg viewBox="0 0 24 24"><path d="M9.5 9a2.5 2.5 0 1 1 4.5 1.5c-.7.6-1.5 1-1.5 2v.5"/><circle cx="12" cy="17" r="0.6" fill="currentColor"/><circle cx="12" cy="12" r="9"/></svg>',
    search: '<svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>',
    pin: '<svg viewBox="0 0 24 24"><path d="M12 22s7-7.58 7-13a7 7 0 1 0-14 0c0 5.42 7 13 7 13z"/><circle cx="12" cy="9" r="2.5"/></svg>',
    heart: '<svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.66l-1.06-1.05a5.5 5.5 0 1 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',
    heartFilled: '<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>',
    back: '<svg viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7"/></svg>',
    star: '<svg viewBox="0 0 24 24"><path d="M12 2l2.39 6.96H22l-6 4.45L18.18 22 12 17.6 5.82 22 8 13.41 2 8.96h7.61L12 2z"/></svg>',
    shield: '<svg viewBox="0 0 24 24"><path d="M12 3l8 3v6c0 5-3.5 8-8 9-4.5-1-8-4-8-9V6l8-3z"/></svg>',
    document: '<svg viewBox="0 0 24 24"><path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><path d="M14 3v6h6"/></svg>',
    calendar: '<svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9h18"/><path d="M8 3v4"/><path d="M16 3v4"/></svg>',
    wallet: '<svg viewBox="0 0 24 24"><path d="M3 8a3 3 0 0 1 3-3h12a2 2 0 0 1 2 2v3"/><path d="M3 8v9a3 3 0 0 0 3 3h13a2 2 0 0 0 2-2v-3"/><circle cx="17" cy="14" r="1.5" fill="currentColor" stroke="none"/></svg>',
    send: '<svg viewBox="0 0 24 24"><path d="M22 2L11 13"/><path d="M22 2l-7 20-4-9-9-4 20-7z"/></svg>',
    chat: '<svg viewBox="0 0 24 24"><path d="M21 12a8 8 0 0 1-11.6 7.14L4 21l1.86-5.4A8 8 0 1 1 21 12z"/></svg>',
    info: '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 8v.01"/><path d="M12 11v5"/></svg>',
    arrow: '<svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg>',
    spark: '<svg viewBox="0 0 24 24"><path d="M12 3v3"/><path d="M12 18v3"/><path d="M3 12h3"/><path d="M18 12h3"/><path d="M5.6 5.6l2.1 2.1"/><path d="M16.3 16.3l2.1 2.1"/><path d="M5.6 18.4l2.1-2.1"/><path d="M16.3 7.7l2.1-2.1"/></svg>',
    ...
    pepper: '<svg viewBox="0 0 24 24"><path d="M14 4c0 2 1 3 3 3"/><path d="M11 6c-4 0-8 3-8 8a6 6 0 0 0 6 6c4 0 7-3 7-7 0-4-2-7-5-7z"/></svg>',
    bunny: '<svg viewBox="0 0 24 24"><path d="M9 3l2 7"/><path d="M15 3l-2 7"/><path d="M7 21a5 5 0 1 1 10 0"/><circle cx="12" cy="14" r="4"/></svg>',
};
...
function openModal(options) {
    ...
    <div class="modal-backdrop ${options.size === "centered" ? "center" : ""}" data-modal-backdrop>
      <div class="modal" role="dialog" aria-modal="true">
        ...
        .map((action, index) => `<button class="button ${action.kind === "secondary" ? "secondary" : action.kind === "ghost" ? "ghost" : action.kind === "danger" ? "danger" : ""}" data-modal-action="${index}">${escapeHtml(action.label)}</button>`)
        .join("")}</div>` : ""}
      </div>
    </div>
  `;
    ...
    modalRoot.querySelectorAll("[data-modal-action]").forEach((node) => {
    ...
    options.onMount?.(modalRoot.querySelector(".modal"));
}
/* Navigation */
...
async function renderBootstrapLock() {
  ...
  `;
    const submit = async () => {
        const input = document.querySelector("#friend-code-input");
...
async function renderCatalog() {
    ...
    attachCommonEvents();
    const data = await api("/api/webapp/catalog/summary");
    ...
    <div class="shell">
      ...
      <section class="section">
        ...
        <div class="tabs">
          ${data.categories
        .map((item) => `<button class="tab${item.key === state.category ? " active" : ""}" data-category="${item.key}">${escapeHtml(item.label)}</button>`)
        .join("")}
        </div>
        <div class="chips" style="margin-top:14px;">
          ${data.cities
        .map((city) => `<button class="chip${city === state.city ? " active" : ""}" data-city="${escapeHtml(city)}">${icon("pin")}<span>${escapeHtml(city)}</span></button>`)
        .join("")}
        </div>
      </section>
...
async function renderSearch() {
    ...
    attachCommonEvents();
    const data = await api(`/api/webapp/cards?category=${state.category}&city=${encodeURIComponent(state.city)}&page=${state.page}`);
    appRoot.innerHTML = `
    <div class="shell">
      ${renderBrandBar()}
      <section class="hero">
...
async function renderCard() {
    ...
    const data = await api(`/api/webapp/cards/${state.cardId}`);
  ...
  `;
    ...
    document.querySelector("#reviews-btn")?.addEventListener("click", async () => {
        try {
            const reviews = await api(`/api/webapp/cards/${card.id}/reviews?page=1`);
            openModal({
    ...
    document.querySelector("#schedule-btn")?.addEventListener("click", async () => {
        try {
            const today = await api(`/api/webapp/cards/${card.id}/schedule?mode=today`);
            const renderModeButtons = (current) => `
      ...
      `;
            openModal({
                ...
                onMount: (root) => {
                    const bind = () => {
                        root.querySelectorAll("[data-schedule-mode]").forEach((node) => {
                            node.addEventListener("click", async () => {
                                const mode = node.dataset.scheduleMode;
                                root.querySelectorAll("[data-schedule-mode]").forEach((tab) => {
                                    tab.classList.toggle("active", tab.dataset.scheduleMode === mode);
                                });
                                const target = root.querySelector("#schedule-body");
                                if (target)
                                    target.innerHTML = "<div class=\"skeleton skeleton-line\" style=\"height:60px;\"></div>";
                                try {
                                    const next = await api(`/api/webapp/cards/${card.id}/schedule?mode=${mode}`);
                                    if (target)
                                        target.innerHTML = next.html;
                                }
                                catch {
                                    if (target)
                                        target.innerHTML = "<p>Не удалось загрузить расписание.</p>";
                                }
                            });
                        });
                    };
    ...
    document.querySelector("#certificate-btn")?.addEventListener("click", async () => {
        try {
            const cert = await api(`/api/webapp/cards/${card.id}/certificate`);
            openModal({
                title: "Сертификат",
    ...
    document.querySelector("#safety-btn")?.addEventListener("click", async () => {
        try {
            const safety = await api(`/api/webapp/cards/${card.id}/safety`);
            openModal({
...
function openBookingModal(cardId) {
    openModal({
    ...
    `,
        ...
        onMount: (root) => {
            root.querySelectorAll("[data-payment]").forEach((node) => {
                node.addEventListener("click", async () => {
                    const paymentMethod = node.dataset.payment;
                    try {
...
async function renderReviews() {
    ...
    appRoot.innerHTML = `<div class="shell">${renderBrandBar()}${skeletonShell(3)}${renderNavigation()}</div>`;
    attachCommonEvents();
    const data = await api("/api/webapp/reviews?page=1");
    appRoot.innerHTML = `
    <div class="shell">
      ${renderBrandBar()}
      <section class="hero">
...
async function renderProfile() {
    ...
    appRoot.innerHTML = `<div class="shell">${renderBrandBar()}${skeletonShell(2)}${renderNavigation()}</div>`;
    attachCommonEvents();
    const data = await api("/api/webapp/profile");
    if (state.bootstrap) {
    ...
    `,
        actions: [
            { label: "Отмена", kind: "ghost" },
            {
                ...
                closeOnClick: false,
                onClick: async () => {
                    const value = Number((document.querySelector("#topup-amount")?.value ?? "").trim());
                    if (!Number.isFinite(value) || value <= 0) {
                        toast("Введите корректную сумму", "error");
                        return;
                    }
                    try {
                        const topup = await api("/api/webapp/topup/create", {
                            method: "POST",
...
function openTopupReceiptModal(topup) {
    openModal({
    ...
    `,
        actions: [
            { label: "Позже", kind: "ghost" },
            {
                ...
                closeOnClick: false,
                onClick: async () => {
                    const input = document.querySelector("#topup-receipt");
  ...
  `;
    document.querySelector("#support-submit")?.addEventListener("click", async () => {
        ...
        try {
            ...
            const textarea = document.querySelector("#support-message");
            if (textarea)
                textarea.value = "";
...
async function renderInfo() {
    ...
    attachCommonEvents();
    const data = await api("/api/webapp/info/info_center");
    appRoot.innerHTML = `
    <div class="shell">
      ${renderBrandBar()}
      <section class="hero">
      ...
      <section class="section">
        ...
        .map((item) => `<button class="info-tile" data-info-key="${escapeHtml(item.key)}">
  ...
  `;
    document.querySelectorAll("[data-info-key]").forEach((element) => {
        element.addEventListener("click", async () => {
            ...
            try {
                const section = await api(`/api/webapp/info/${key}`);
                openModal({
...
async function bootstrap() {
    ...
    state.screen = (requestedScreen && requestedScreen in SECTION_LABELS
        ? requestedScreen
        : state.bootstrap?.initialScreen ?? "catalog");
