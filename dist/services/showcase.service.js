...
function buildModelCardText(card) {
    ...
    return [
        ...
        "",
        "<b>🔐 УСЛОВИЯ:</b>",
        "• Первое бронирование подтверждается депозитом от 1,000 RUB.",
...
function buildModelSafetyPolicyText() {
    return [
        "<b>🛡 ПОЛИТИКА БЕЗОПАСНОСТИ И УСЛОВИЯ ЗНАКОМСТВА</b>",
        "",
        "Уважаемый пользователь!",
        "",
        "Платформа Honey Bunny создана для комфортного и безопасного общения между совершеннолетними пользователями.",
        "Мы уделяем внимание верификации анкет, прозрачности бронирования и защите приватности.",
        "",
        "<b>Условия первого знакомства:</b>",
        "✅ Подтверждение серьёзности намерений оформляется через депозит в интерфейсе модели.",
        "✅ Средства резервируются системой как гарантийный депозит до подтверждения завершения встречи.",
        "✅ Анкеты проходят проверку, а дополнительные подтверждённые данные доступны по запросу через поддержку.",
        "✅ Личные данные пользователя не запрашиваются сверх необходимого минимума для работы платформы.",
        "",
        "<b>Дальнейшее общение:</b>",
        "После первого успешно завершённого знакомства платформа открывает расширенные условия бронирования для доверенных пользователей.",
        "Повторные встречи можно согласовывать на более гибких условиях внутри сервиса.",
        "",
        "<b>Гарантия соответствия:</b>",
        "Если профиль не соответствует условиям бронирования, пользователь может отменить встречу и обратиться в поддержку для проверки ситуации и возврата средств по правилам платформы.",
        "",
